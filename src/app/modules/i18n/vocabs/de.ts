...
export const locale = {
  ...
  data: {
    ...
    INVENTORY: {
      Create: "Erstellen",
      CreatedSuccess: "Erstellen",
      CreateItem: "Inventargegenstand erstellen",
      Name: "Name",
      Category: "Kategorie",
      ...
      StockRequired: "Lagerbestand ist erforderlich",
      StockMin: "Lagerbestand muss mindestens 0 sein",
      PriceRequired: "Preis ist erforderlich",
      PriceMin: "Preis muss mindestens 0 betragen",
